...
void ConfigEdit::InitGui()
{
    ...
    if (!message_) return;
    ui.proto_nameEdit->setText(std::string(message_->GetTypeName()).c_str());
    ...
    for (int i = 0; i < field_count; i++)
    {
        ...
        case google::protobuf::FieldDescriptor::TYPE_INT64:
            ...
            ui.formLayout->addRow(std::string(field->name()).c_str(), int_box);
        ...
        case google::protobuf::FieldDescriptor::TYPE_DOUBLE:
            ...
            ui.formLayout->addRow(std::string(field->name()).c_str(), double_box);
        ...
        case google::protobuf::FieldDescriptor::TYPE_STRING:
            ...
            ui.formLayout->addRow(std::string(field->name()).c_str(), str_edit);
        ...
        case google::protobuf::FieldDescriptor::TYPE_BOOL:
            ...
            ui.formLayout->addRow(std::string(field->name()).c_str(), combo_box);
...
void ConfigEdit::LoadProto()
{
    ...
    QString filename = QFileDialog::getOpenFileName(this,
        QString::fromUtf8("请选择proto文件"), "", "*.proto");
    if (filename.isEmpty())
        return;
